...
[Ítems dicotómicos (PDF)](projects/TRI_DICO.pdf). En éste informe se aplica un modelo para ítems con dos opciones de respuesta (acierto/fallo).
...
Una práctica sobre la detección de señales mediante la cual estudiamos el patrón de respuesta de varios observadores.
